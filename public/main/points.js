...
var totalPointsRef = db.doc("'leaderboards'/'totalPoints'/'totalPoints'/user.displayName");
...
var memeUploadsRef = db.doc("'leaderboards'/'totalPoints'/'totalPoints'/user.displayName");
